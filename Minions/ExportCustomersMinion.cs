// <copyright file="ExportCustomersMinion.cs" company="Sitecore Corporation">
...
{
    /// <summary>
    /// Defines the export customers minion.
    /// </summary>
    /// <seealso cref="Sitecore.Commerce.Core.Minion" />
    public class ExportCustomersMinion : Minion
    {
        /// <summary>
        ...
        /// The minion pipeline.
        /// </value>
        protected IExportCustomersMinionPipeline MinionPipeline { get; set; }
        ...
        public override void Initialize(IServiceProvider serviceProvider, MinionPolicy policy, CommerceContext commerceContext)
        {
            ...
            MinionPipeline = serviceProvider.GetService<IExportCustomersMinionPipeline>();
        }
        ...
        protected override async Task<MinionRunResultsModel> Execute()
        {
            ...
            {
                var items = await GetListIds<Customer>(listToWatch, int.MaxValue).ConfigureAwait(false);
                ...
                foreach (var entityId in items.EntityReferences.Select(e => e.EntityId))
                {
                    ...
                    Logger.LogDebug($"{Name}-Exporting Customer: '{entityId}'. Environment: {MinionContext.Environment.Name}");
            ...
            Logger.LogInformation($"{Name}-Exporting Customers Completed: {(int)itemsProcessed}. Environment: {MinionContext.Environment.Name}");
