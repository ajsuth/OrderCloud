// <copyright file="ExportSellableItemsMinion.cs" company="Sitecore Corporation">
...
{
    /// <summary>
    /// Defines the export sellable items minion.
    /// </summary>
    /// <seealso cref="Sitecore.Commerce.Core.Minion" />
    public class ExportSellableItemsMinion : Minion
    {
        /// <summary>
        ...
        /// The minion pipeline.
        /// </value>
        protected IExportSellableItemsMinionPipeline MinionPipeline { get; set; }
        ...
        public override void Initialize(IServiceProvider serviceProvider, MinionPolicy policy, CommerceContext commerceContext)
        {
            ...
            MinionPipeline = serviceProvider.GetService<IExportSellableItemsMinionPipeline>();
        }
        ...
        protected override async Task<MinionRunResultsModel> Execute()
        {
            ...
            {
                var items = await GetListIds<SellableItem>(listToWatch, int.MaxValue).ConfigureAwait(false);
                ...
                foreach (var entityId in items.EntityReferences.Select(e => e.EntityId))
                {
                    ...
                    Logger.LogDebug($"{Name}-Exporting Sellable Item: '{entityId}'. Environment: {MinionContext.Environment.Name}");
            ...
            Logger.LogInformation($"{Name}-Exporting Sellable Items Completed: {(int)itemsProcessed}. Environment: {MinionContext.Environment.Name}");
