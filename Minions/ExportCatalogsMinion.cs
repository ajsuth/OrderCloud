// <copyright file="ExportCatalogsMinion.cs" company="Sitecore Corporation">
...
{
    /// <summary>
    /// Defines the export catalogs minion.
    /// </summary>
    /// <seealso cref="Sitecore.Commerce.Core.Minion" />
    public class ExportCatalogsMinion : Minion
    {
        /// <summary>
        ...
        /// The minion pipeline.
        /// </value>
        protected IExportCatalogsMinionPipeline MinionPipeline { get; set; }
        ...
        public override void Initialize(IServiceProvider serviceProvider, MinionPolicy policy, CommerceContext commerceContext)
        {
            ...
            MinionPipeline = serviceProvider.GetService<IExportCatalogsMinionPipeline>();
        }
        ...
        protected override async Task<MinionRunResultsModel> Execute()
        {
            ...
            {
                var items = await GetListIds<Catalog>(listToWatch, int.MaxValue).ConfigureAwait(false);
                ...
                foreach (var entityId in items.EntityReferences.Select(e => e.EntityId))
                {
                    ...
                    Logger.LogDebug($"{Name}-Exporting Catalog: '{entityId}'. Environment: {MinionContext.Environment.Name}");
            ...
            Logger.LogInformation($"{Name}-Exporting Catalogs Completed: {(int)itemsProcessed}. Environment: {MinionContext.Environment.Name}");
